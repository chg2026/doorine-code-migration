...
Only edit files inside `apps/investor-portal/`.
Never modify files in `apps/chg-rehab/`, `apps/deallink/`, `apps/contractor-portal/`, `server/`, `packages/`, or any root-level config files.
